import FadeIn from "@/registry/components/eldoraui/fade-in";
import Marquee from "@/registry/components/eldoraui/marquee";
import TweetCard from "@/registry/components/eldoraui/tweet-card";
    ...
    <section id="testimonials" className="container py-14">
      <FadeIn delay={0.3}>
        ...
        <h3 className="text-foreground/80text-lg mb-8 text-center font-medium tracking-tight">
          ...
          <strong>real people</strong> are saying about eldora UI on Twitter.
        </h3>
      </FadeIn>
