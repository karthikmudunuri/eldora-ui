...
export function constructMetadata({
  title = "Eldora UI - Modern React + Tailwind CSS components & Templates",
  description = "Eldora UI is a curated collection of the best landing page components built using React + Tailwind CSS + Framer Motion",
  ...
  return {
    ...
    twitter: {
      ...
      description,
      images: [image],
      creator: "@Karthikeyavarma",
    },
    icons: "/favicon.ico",
    metadataBase: new URL("https://magicui.design"),
    authors: [
      {
        name: "Karthikeyavarma",
